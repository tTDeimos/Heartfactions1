...
void CalculateMinimapColour( CMap@ map, u32 offset, TileType tile, SColor &out col)
{
	...
	const SColor color_minimap_solid_edge   (0xff9d5c3b);
	const SColor color_minimap_solid        (0xff9d5c3b);
	const SColor color_minimap_back_edge    (0xff9d5c3b); //yep, same as above
	const SColor color_minimap_back         (0xff9d5c3b);
	const SColor color_minimap_open         (0xfff4ddb1);
	const SColor color_minimap_gold         (0xff9d5c3b);
	const SColor color_minimap_gold_edge    (0xff9d5c3b);
	const SColor color_minimap_gold_exposed (0xff9d5c3b);

	const SColor color_minimap_water        (0xff36d0e6);
	const SColor color_minimap_fire         (0xffc94e3e);
