...
bool GiveSpawnResources(CRules@ this, CBlob@ blob, CPlayer@ player, CTFPlayerInfo@ info)
{
	...
	{
		ret = SetMaterials(blob, "mat_wood", 100) || ret; //100
		ret = SetMaterials(blob, "mat_stone", 125) || ret; //125
	...
	/*else if (blob.getName() == "migrant")
	{
		ret = SetMaterials(blob, "food", 1) || ret;
