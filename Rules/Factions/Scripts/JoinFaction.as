    ...
    if(args.length > 0)
    {
                ...
                {   
                    ...
                    if(createfaction == 0)
                    {
                        ...
                        if(fBase !is null)
                        {
                            ...
                            changeClass(blob, "engineer", fact2.team); // 2nd class
        ...
        else if(args[0] == "!leave")
        {
            ...
            if(fact !is null)
            {
                ...
                player.server_setCoins(0);
                core.ChangePlayerTeam(player, -1); //TEAM WHEN YOU LEAVE BOI
        ...
        else if(args[0] == "!help")
        {
            if(args.length == 1)
            {
                send_chat(this, player, "Welcome to The Hearth Factions! This world revolves around the huge fire.", SColor(255, 255, 0, 0));
                send_chat(this, player, "There are many items you can throw into the fire, some obivous and some not.", SColor(255, 255, 0, 0));
                send_chat(this, player, "You start as a peasant, but if you obtain 20 coins you can create your own faction-", SColor(255, 255, 0, 0));
                send_chat(this, player, "With the command !create (factionname). There are many commands, here is the full list:", SColor(255, 255, 0, 0));
            ...
            else if(args.length == 2)
            {
                ...
                if(t == "create")
                {
                    ...
                    send_chat(this, player, "When you are a peasant, you must obtain 20 coins before creating a faction.", SColor(255, 255, 0, 0));
                }
                else if(t == "invite")
                {
