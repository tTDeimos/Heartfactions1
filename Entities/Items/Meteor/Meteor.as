...
void onInit(CBlob@ this)
{
	...
	this.set_f32("explosive_radius",400.0f);
	this.set_f32("explosive_damage",6.0f);
	this.set_string("custom_explosion_sound", "Entities/Items/Explosives/KegExplosion.ogg");
	this.set_f32("map_damage_radius", 232.0f);
	this.set_f32("map_damage_ratio", 1.1f);
...
void onTick( CBlob@ this )
{
    ...
    {
        this.server_Die();
        server_CreateBlob("sunstone",-1,this.getPosition());
    }
    else
    {
