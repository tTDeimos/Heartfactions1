...
const int DELTA_END_ATTACK = 4;
const f32 DEFAULT_ATTACK_DISTANCE = 18.0f;
const f32 MAX_ATTACK_DISTANCE = 19.0f;
const f32 SHIELD_KNOCK_VELOCITY = 4.0f;
