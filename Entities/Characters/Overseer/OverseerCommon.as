...
namespace KnightVars
{
	...
	const ::s32 slash_charge = 16;
	const ::s32 slash_charge_level2 = 50;
	const ::s32 slash_charge_limit = slash_charge + 10;
	const ::s32 slash_move_time = 4;
	const ::s32 slash_time = 13;
	const ::s32 double_slash_time = 30;

	const ::f32 slash_move_max_speed = 2.1f;
...
const f32 DEFAULT_ATTACK_DISTANCE = 34.5f;
const f32 MAX_ATTACK_DISTANCE = 40.0f;
const f32 SHIELD_KNOCK_VELOCITY = 4.2f;
