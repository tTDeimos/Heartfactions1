...
void onTick(CSprite@ this)
{
	...
	{
		this.SetAnimation("hide_bush");
		this.animation.frame = hide_type;
	}
	else if (pressed_a1 && !pressed_a2)
	{
		hide_type = XORRandom(13);
	}

	if ((pressed_a2) and (showedsmoke == false))
	{
		showedsmoke = true;
		CParticle@ smoke = ParticleAnimated(CFileMatcher("Smoke.png").getFirst(), pos, Vec2f(0, 0), 0.0f, 1.0f, 3, 0.0f, false);
		if (smoke !is null)
	    {
	        smoke.width = 8;
	        smoke.height = 8;
