//Auto-mining quarry
//converts bog into flour

const string fuel = "grain";
const string ore = "flour";
const string rare_ore = "flour";

//balance
const int input = 1;					//input cost in fuel
const int output = 1;					//output amount in ore
...
const int max_fuel = 6;
const int mid_fuel = 3;
const int low_fuel = 1;
...
void onInit(CSprite@ this)
{
	...
	CSpriteLayer@ wood = this.addSpriteLayer("wood", "Mill.png", 16, 16);
	if (wood !is null)
	{
...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
	...
	{
		CButton@ button = caller.CreateGenericButton("$bucketofgrain$", Vec2f(-4.0f, 0.0f), this, this.getCommandID("add fuel"), getTranslatedString("Add fuel"), params);
		if (button !is null)
		{
