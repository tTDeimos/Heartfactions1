...
void onInit(CBlob@ this)
{
	...
	this.set_string("required class", "apprenticeofthesun");

	{
		ShopItem@ s = addShopItem(this, "Rain Charge", "$raincharge$", "raincharge", "You are terrified just looking at it.", true);
